function pumpkinChoices() {
  document.getElementById("picture1").src = "/Pics/round-pumpkin.jpg";
  document.getElementById("picture2").src = "/Pics/tall-pumpkin.jpg";
  document.getElementById("picture3").src = "/Pics/short-pumpkin.jpg";
}
